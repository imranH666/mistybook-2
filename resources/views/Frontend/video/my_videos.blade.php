        ...
        <div class="col-lg-12">
            <div class="row">
                @foreach ($videos as $video)
                    <div class="col-lg-12">
                        <div class="video-container my-videos">
                            <div class="video-item my-videos-item">
                                <button onclick="deleteMyVideo('{{ route('delete.video', $video->id) }}')" class="delete-video-btn">Delete Video</button>
                                ...
                                <div class="video-div">
                                    ...
                                    <video id="video{{ $video->id }}" src="{{ asset('upload/videos') }}/{{ $video->video_name }}"></video>
                                </div>
